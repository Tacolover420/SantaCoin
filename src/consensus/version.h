...
#ifndef SANTACOIN_VERSION_H
#define SANTACOIN_VERSION_H
...
static const int CANONICAL_BLOCK_SIG_VERSION = 60006;
static const int CANONICAL_BLOCK_SIG_LOW_S_VERSION = 60006;
