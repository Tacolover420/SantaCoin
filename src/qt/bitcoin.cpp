...
#if defined(SANTACOIN_NEED_QT_PLUGINS) && !defined(_SANTACOIN_QT_PLUGINS_INCLUDED)
#define _SANTACOIN_QT_PLUGINS_INCLUDED
#define __INSURE__
#include <QtPlugin>
...
int main(int argc, char *argv[])
{
    ...
    mapMultiArgs["-addnode"].push_back("159.203.14.113:11120");
