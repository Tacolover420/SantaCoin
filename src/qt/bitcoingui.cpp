    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("SantaCoin") + " - " + tr("Client"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("SantaCoin");
    setStyleSheet("#SantaCoin {background-image: url(:/images/qt) }"); //qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #499bea, stop: 1 #207ce5
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    blockbrowserAction->setToolTip(tr("Browse and access block details of the SantaCoin chain"));
    ...
    aboutAction = new QAction(QIcon(":icons/SantaCoin"), tr("&About SantaCoin"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/SantaCoin"), tr("&Show / Hide"), this);
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit SantaCoin.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for SantaCoin"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit SantaCoin.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for SantaCoin (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where SantaCoin data is stored"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ad170b; font-weight:bold;} QToolButton:hover { background-color: #3f0703 } QToolButton:checked { background-color: #ae3e35 } QToolButton:pressed { background-color: #990000 } #tabs { color: #ad170b; background-color: #e6f8fe; border: none }");
