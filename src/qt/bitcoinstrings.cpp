...
"for example: alertnotify=echo %%s | mail -s \"SantaCoin Alert\" admin@foo."
"com\n"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. SantaCoin is shutting down."),
