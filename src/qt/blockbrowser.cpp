...
void BlockBrowser::updateExplorer(bool block)
{
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " SANTA");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " SANTA");
    }
}
...
void BlockBrowser::updateStatistics()
{
    ...
    {
        ui->volumeBox_2->setText("<b><font color=\"green\">" + qVolume + " SANTA" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox_2->setText("<b><font color=\"red\">" + qVolume + " SANTA" + "</font></b>");
    } else {
        ui->volumeBox_2->setText(qVolume + " SANTA");
    }
