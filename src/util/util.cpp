                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
    {
        boost::filesystem::path ConfPath;
               ConfPath = GetDataDir() / "SantaCoin.conf";
               ...
               fprintf(ConfFile, "port=11120\n");
               fprintf(ConfFile, "rpcport=11122\n");
               fprintf(ConfFile, "rpcconnect=127.0.0.1\n");
               fprintf(ConfFile, "addnode=192.168.1.144:11120\n");
               fprintf(ConfFile, "addnode=159.203.14.113:11120\n");
